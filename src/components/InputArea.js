            ...
            <Grid container spacing={40} style={{ paddingTop: "40px" }} direction="column" >
                ...
                <Grid container item direction="row" justify='flex-start' alignItems="center" spacing={40}>
                    ...
                    <div style={{ paddingLeft: "30px" }}>
                        <Fab id="buttonPort" variant="extended" color="primary" size="large" onClick={this.deckButtonClick}>
                            Make a deck!
                        </Fab>
                    </div>
                </Grid>
                <Snackbar
                    ...
                    message={<span id="porterr-msg">We couldn't find that Quizlet <span role="img" aria-label="disappointed-face">😔</span>Please try again!</span>}
                />
                <Snackbar
                    anchorOrigin={{ vertical: "bottom", horizontal: "center" }}
                    open={badUrl}
                    ...
                    message={<span id="message-id">Make sure your URL is correct <span role="img" aria-label="eyes">👀</span></span>}
                />
            </Grid >
        );
    }
